...
fn main() {
    ...
    println!("cargo:rerun-if-changed=vendored/include");
    println!("cargo:rerun-if-changed=vendored/src");
    ...
    if openssl_version >= 0x1010_1000 {
    ...
    */
    ...
    if openssl_version < 0x1010_0000 {
