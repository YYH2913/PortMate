...
channel tests do not claim successful authentication: a real Kerberos realm, ticket cache, and
GSSAPI-enabled SSH server success/failure matrix is still required.
...
Still pending: the real Kerberos/GSSAPI server matrix and unsupported libssh transport combinations,
