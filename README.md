...
- Standalone serial analyzer window with capture/delimiter/fixed-length/idle-gap framing, RFC 1055 SLIP, COBS, and Modbus RTU decoding, bookmarks, filtering, paging, and exact source-frame export
