...
emits approximately 496.7 kB of main JS, 467.3 kB of terminal core JS, 120.4 kB of WebGL JS,
140.3 kB of main CSS, 13.2 kB for the MCP workspace, 11.7 kB for the OneKeys manager, 4.7 kB for
...
The workspace suite also resolves two log previews in reverse order and holds MCP HTTP configuration across repeated tab activation, covering the dialog request gates rather than relying only on unit-level gate behavior.
