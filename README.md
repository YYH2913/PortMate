...
- WindTerm-style OneKeys manager for encrypted Account/SSH credentials, bound public-key identities, session binding, and explicit terminal injection
