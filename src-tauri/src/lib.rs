...
use portmate_core::{
    ...
    TunnelSpec, DEFAULT_TFTP_PORT, MAX_COMMAND_HISTORY_ENTRIES, MAX_CUSTOM_SCRIPTS,
    MAX_MCP_CONTENT_UPLOAD_BYTES, MAX_MCP_TERMINAL_TEXT_BYTES,
    MAX_MCP_TUNNEL_EXCHANGE_BASE64_LENGTH, MAX_MCP_TUNNEL_EXCHANGE_BYTES,
    MAX_MCP_TUNNEL_EXCHANGE_TIMEOUT_MS, MAX_MCP_UDP_DATAGRAM_BASE64_LENGTH,
    MAX_MCP_UDP_DATAGRAM_BYTES, MAX_TUNNELS_PER_PROFILE, MAX_TUNNEL_HOST_CHARACTERS,
