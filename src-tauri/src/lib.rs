...
use portmate_core::{
    ...
    normalize_tunnels, prompt_templates, redact_custom_script_event_bodies, redact_secrets,
    redact_session_event, redact_session_events, redact_session_summary, redact_transfer_task,
    resource_templates, tool_definitions, tunnel_route_allowed, validate_custom_script,
