...
当前 Rust workspace 自动化测试总数为 100：`portmate` 70、`portmate-kdf` 1、`portmate-core` 18、`portmate-mcp` 11；`npm test` 另有 4 个前端 transfer state 单元测试。
