...
1. `lib.rs` 已累计减少约 21,700 行，并按以下边界持续拆分：
   ...
   下一步继续审计正式 SSH handler 与剩余命令编排 ownership。
