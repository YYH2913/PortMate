...
1. `lib.rs` 已累计减少约 29,000 行，并按以下边界持续拆分；主文件不再直接拥有 Tauri command：
   ...
   命令适配 ownership 与 Sysmon 采集/解析边界已收敛；下一步继续拆分仍在主文件中的凭据迁移规划/诊断编排和大型测试夹具。
