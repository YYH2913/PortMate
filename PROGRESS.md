...
| 测试体系 | 部分实现 | 245 项 Rust core/协议集成测试、46 文件/239 项前端单测和仓库内终端/Tmux/workspace UI Playwright 基线可用；其他 UI 检查迁移、完整 vttest、真实全屏程序和跨平台矩阵仍不足。 |
