...
3. MCP 官方 TypeScript SDK 1.29.0、Python SDK 1.9.4/1.15.0/1.23.3/1.28.1、Go SDK 1.4.0/1.5.0/1.6.1、Rust SDK `rmcp` 1.0.0/1.1.0/1.8.0/2.2.0、Ruby SDK 0.25.0/1.0.0、Java SDK 1.0.0/1.1.3/2.0.0、Kotlin SDK 0.14.0、C# SDK 1.4.1 与 Swift SDK 0.12.1 的 stdio/HTTP 矩阵已纳入回归；继续扩展版本和客户端实现。
