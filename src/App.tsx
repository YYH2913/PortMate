...
function normalizeTerminalPrefs(value: unknown): TerminalPrefs {
  ...
  return {
    ...
    completionTriggerChars: [1, 2, 3].includes(source.completionTriggerChars!) ? source.completionTriggerChars! : defaults.completionTriggerChars,
    completionListHeight: [5, 7, 10].includes(source.completionListHeight!) ? source.completionListHeight! : defaults.completionListHeight,
    completionPreviewMode: stringPreference(source.completionPreviewMode, ["none", "input", "top"], defaults.completionPreviewMode),
